...
<fieldset>
	...
	<div class="control-group">
		...
		<label class="checkbox">
			<input type="checkbox" class="input-xlarge" id="email-as-username-enable" name=email-as-username-enable <?php echo $settings->getOption('email-as-username-enable', true); ?>>
	...
	<div class="control-group">
		...
		<label class="checkbox">
			<input type="checkbox" class="input-xlarge" id="email-welcome-disable" name="email-welcome-disable" <?php echo $settings->getOption('email-welcome-disable', true); ?>>

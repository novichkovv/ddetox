...
<div class="container" style="text-align: center;">
    <?php if($data['video']): ?>
        ...
        <div id="package" class="col-xs-12 col-sm-5">
            ...
            <a href="http://www.drcolbert.com/21-day-detox-package.html" target="_blank"><img src="<?php echo SITE_DIR; ?>images/detoxpack.jpg"  style="width: 80%; margin: 0 10%; float: left"></a>

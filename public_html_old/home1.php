...
<div class="wrapper">
    <div class="newspaper-left">
     ...
     <a href="backend/sign_up.php">Free Signup<div class="diva-icon"> &#128237; </div> <div class="diva"></div>  </a><br />
	 ...
	 <!-- New Signup Button <img src="img/nextdetoxbtn.jpg" alt="Signup for the 21 Day Detox is Now Closed" /> -->
        ...
        <h2 class="newspaper-header">Companion Package</h2>
        	<div class="newspaper-body">
        <a href="http://www.drcolbert.com/21-day-detox-package.html"><img src="http://divinehealthdetox.com/img/detoxpack.jpg" />Detox Package</a>
        	</div>
        </div>
        ...
        <h2 class="newspaper-header">Tip of The Day</h2>
           <div class="newspaper-body">
           <?php
		   $startDate=date_create("2014-09-22");
		   ...
		   ?>
			<a href="<?php if( !protectThis("1,2,3, 4") ) {echo "http://www.divinehealthdetox.com/backend/sign_up.php"; } else { echo "http://divinehealthdetox.com/backend/home.php"; } ?>"><img src="http://divinehealthdetox.com/backend/assets/img/<?php echo $image; ?>.png" alt="Tip 1" /></a>
        	</div>
        </div>
...
<iframe src="http://www.intagme.com/in/?u=ZGl2aW5laGVhbHRobnV0cml0aW9ufGlufDIwMHwxfDJ8fHllc3w1fHVuZGVmaW5lZHxubw==" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:215px; height: 430px" ></iframe>
    ...
    <div class="newspaper-center">
     ...
     <br />
            ...
            <a href="<?php if( !protectThis("1,2,3, 4") ) {echo "http://www.divinehealthdetox.com/backend/sign_up.php"; } else { echo "/backend/ebook.php"; } ?>"><img src="img/ebooklet.png" alt="Dr. Colbert's 21 Day Detox E-Booklet" /></a>
			<p><iframe width="420" height="280" src="//www.youtube.com/embed/TmM-k7dkMBA" frameborder="0" allowfullscreen></iframe></p>
       ...
       <a href="http://www.drcolbert.com/21-day-detox-package.html"><img src="http://divinehealthdetox.com/img/detoxpack.jpg" />Detox Package</a>
        ...
        <h2 class="newspaper-header">Latest Recipes</h2>
        	<div class="newspaper-body" style="display:inline-block;">
                <div class="list"><a href="<?php if( !protectThis("1,2,3, 4") ) {echo "http://www.divinehealthdetox.com/backend/sign_up.php"; } else { echo "http://divinehealthdetox.com/backend/soups.php"; } ?>"><img class="recipe-image" src="http://divinehealthdetox.com/img/hot-sour-soup.jpg" /><br />Hot and Sour Soup</a></div>
                <div class="list"><a href="<?php if( !protectThis("1,2,3, 4") ) {echo "http://www.divinehealthdetox.com/backend/sign_up.php"; } else { echo "http://divinehealthdetox.com/backend/salads.php"; } ?>"><img class="recipe-image" src="http://divinehealthdetox.com/img/warm-salad.jpg" /><br />Warm Spring Salad</a></div>
            </div>
        </div>
...
<div class="slider2">
	<div class="slide1">
		<div class="slide-img"> <img src="img/detoxpackage.png" alt="" />
		</div>
		<div class="slide-txt">
			<h3> Detox Package </h3>

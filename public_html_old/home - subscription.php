...
<video autoplay loop poster="/img/landing/flowers.jpg" id="bgvid">
...
<div class="wrapper">
    <div class="newspaper-left">
     ...
     <a href="https://www.divinehealthdetox.com/shop/home.php">Subscribe<div class="diva-icon"> &#128237; </div> <div class="diva"></div>  </a><br />
	 ...
	 <!-- New Signup Button <img src="img/nextdetoxbtn.jpg" alt="Signup for the 21 Day Detox is Now Closed" /> -->
        ...
        <h2 class="newspaper-header">Companion Package</h2>
        	<div class="newspaper-body">
        <a href="https://www.divinehealthdetox.com/shop/home.php"><img src="http://divinehealthdetox.com/img/detoxpackage.png" />Detox Package</a>
        	</div>
        </div>
...
<iframe src="http://www.intagme.com/in/?u=ZGl2aW5laGVhbHRobnV0cml0aW9ufGlufDIwMHwxfDJ8fHllc3w1fHVuZGVmaW5lZHxubw==" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:215px; height: 430px" ></iframe>
    ...
    <div class="newspaper-center">
     ...
     <a href="https://www.divinehealthdetox.com/shop/home.php">Subscribe<div class="diva-icon"> &#128237; </div> <div class="diva"></div>  </a><br /><br />
     <a href="backend/login.php"> Login  <div class="diva-icon"> &#128273; </div> <div class="diva"></div>  </a>
     ...
     <br />
            ...
            <p style="font-weight:bold; line-height:1.5; text-align:left; text-indent:50px;"><!-- Join Dr. Colbert for a 21 Day Detox. The 21 Day Detox is created to restore the body’s ability to heal itself. It aims to cleanse and detoxify the body by making healthy changes in diet and taking the right supplements. A few of the outstanding health benefits from the 21 Day Detox can include great skin health, more energy, improved digestion, better sleep, clarity of mind and reduced headaches, bloating, constipation and joint pain. --> <!-- <a href="http://divinehealthdetox.com/backend/sign_up.php">Sign up for free now.</a></p> -->
                <div id="home-check">
                	<p id="check-head"><b>YOUR 21 DAY DETOX SUBSCRIPTION INCLUDES:</b></p>
                    <div id="checkmarks">
            ...
            <a href="<?php if( !protectThis("1,2,3, 4") ) {echo "https://www.divinehealthdetox.com/shop/home.php"; } else { echo "/backend/ebook.php"; } ?>"><img src="img/ebooklet.png" alt="Dr. Colbert's 21 Day Detox E-Booklet" /></a>
...
<div class="slider2">
	<div class="slide1">
		...
		<div class="slide-txt">
			<h3> Detox Package </h3>
			<p class="subtitle"> Learn More at <a href="https://divinehealthdetox.com/shop/home.php">DrColbert.com</a></p>
    ...
    <div class="slide1">
		<div class="slide-img"> <a href="http://www.drcolbert.com/living-green-superfood.html"><img src="img/2cube.png" alt="" /></a>
		</div>
		<div class="slide-txt">
...
how to maximize your results!</p>
         <center><a href="https://www.divinehealthdetox.com/shop/home.php"> Subscribe  <div class="diva-icon"> &#128273; </div> <div class="diva"></div>  </a>
